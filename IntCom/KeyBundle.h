...
struct intcom_keyBundle {
	unsigned char client[AEM_INTCOM_SERVER_COUNT][crypto_secretbox_KEYBYTES]; // Client's keys for each server
	unsigned char server[AEM_INTCOM_CLIENT_COUNT][crypto_secretbox_KEYBYTES]; // Server's keys for each client
