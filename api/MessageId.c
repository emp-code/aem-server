...
// Message IDs contain the UserID, sending address, and timestamp. The data is protected by a secret Base32 encoding. This protection can only be reversed through the admin-only Message/Sender API.
