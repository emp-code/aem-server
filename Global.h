...
#define AEM_LEN_PRIVATE (AEM_USER_SIZE - AEM_KDF_UAK_KEYLEN - AEM_USK_KEYLEN - AEM_EPK_KEYLEN - 8 - AEM_ADDRESSES_PER_USER - (8 * AEM_ADDRESSES_PER_USER))
...
#define AEM_EPK_KEYLEN crypto_kem_PUBLICKEYBYTES // Envelope Public Key
...
#define AEM_EVP_MINBLOCKS 36
#define AEM_EVP_MAXSIZE 2098272 // ((2^16 - 1) + 36) * 32
#define AEM_EVP_OVERHEAD (1 + crypto_kem_CIPHERTEXTBYTES)
#define AEM_MSG_MAXSIZE (AEM_EVP_MAXSIZE - AEM_EVP_OVERHEAD)
