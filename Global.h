...
#define AEM_API_BODY_KEYSIZE crypto_aead_aegis256_KEYBYTES
...
#define AEM_INTCOM_RESPONSE_USAGE    (INT32_MIN + 8) // -40
#define AEM_INTCOM_RESPONSE_PERM     (INT32_MIN + 9) // -39
#define AEM_INTCOM_RESPONSE_EXIST    (INT32_MIN + 10) // -38
#define AEM_INTCOM_RESPONSE_NOTEXIST (INT32_MIN + 11) // -37
#define AEM_INTCOM_RESPONSE_PARTIAL  (INT32_MIN + 12) // -36
#define AEM_INTCOM_RESPONSE_LIMIT    (INT32_MIN + 13) // -35
#define AEM_INTCOM_RESPONSE_FORBID   (INT32_MIN + 14) //-34
...
enum aem_api_command_get {
	...
	AEM_API_MESSAGE_SENDER, // 8
	AEM_API_SETTING_LIMITS  // 9
};
...
enum aem_api_command_post {
	...
	AEM_API_MESSAGE_UPLOAD, // 3
	AEM_API_MESSAGE_VERIFY, // 4
	AEM_API_PRIVATE_UPDATE  // 5
};
