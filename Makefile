...
aem-acc: account/*.c
	$(CC) $(CFLAGS) -DAEM_ACCOUNT -o aem-acc account/*.c Common/Addr32.c Common/AddrToHash.c Common/AEM_KDF.c Common/SetCaps.c Common/binTs.c Common/memeq.c IntCom/Client.c IntCom/Server.c IntCom/peerok.c -lsodium -lcap -lm
