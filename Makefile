...
all: aem-manager aem-account aem-deliver aem-enquiry aem-storage aem-api-clr aem-api-oni aem-mta aem-web-clr aem-web-oni utils/BinCrypt utils/Creator utils/DataCrypt utils/ManagerClient utils/WebMaker
