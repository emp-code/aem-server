...
aem-acc: account/*.c
	$(CC) $(CFLAGS) -DAEM_ACCOUNT -o aem-acc account/*.c Common/Addr32.c Common/AddrToHash.c Common/AEM_KDF.c Common/SetCaps.c Common/binTs.c Common/memeq.c IntCom/Client.c IntCom/Server.c IntCom/peerok.c -lsodium -lcap
...
aem-sto: storage/*.c
	$(CC) $(CFLAGS) -DAEM_STORAGE -o aem-sto storage/*.c Common/AEM_KDF.c Common/Envelope.c Common/Message.c Common/Signature.c Common/SetCaps.c Common/binTs.c IntCom/Client.c IntCom/Server.c IntCom/peerok.c -lsodium -lcap

aem-reg: reg/*.c
	$(CC) $(CFLAGS) -DAEM_REG -o aem-reg -DAEM_UDS reg/*.c Common/AcceptClients.c Common/CreateSocket.c Common/SetCaps.c Common/binTs.c IntCom/Client.c IntCom/peerok.c -lsodium -lcap

aem-web: web/*.c
	$(CC) $(CFLAGS) -DAEM_WEB -o aem-web -DAEM_UDS web/*.c Common/CreateSocket.c Common/SetCaps.c -lsodium -lcap

aem-api: api/*.c
	$(CC) $(CFLAGS) -DAEM_API -o aem-api -DAEM_UDS api/*.c Common/AEM_KDF.c Common/AcceptClients.c Common/Addr32.c Common/CreateSocket.c Common/Message.c Common/SetCaps.c Common/ValidDomain.c Common/ValidEmail.c Common/ValidUtf8.c Common/binTs.c Common/memeq.c Common/x509_getCn.c IntCom/Client.c IntCom/peerok.c -lsodium -lcap -lwolfssl

aem-mta: mta/*.c
	$(CC) $(CFLAGS) -DAEM_MTA -o aem-mta mta/*.c Common/AcceptClients.c Common/Addr32.c Common/CreateSocket.c Common/SetCaps.c Common/memeq.c Common/ValidIp.c Common/binTs.c Common/x509_getCn.c IntCom/Client.c IntCom/Stream_Client.c IntCom/peerok.c -lsodium -lcap -lwolfssl
...
utils/Creator: utils/Creator.c
	$(CC) $(CFLAGS) -o utils/Creator -DAEM_KDF_UMK utils/Creator.c Common/AddrToHash.c Common/AEM_KDF.c Common/Envelope.c Common/Message.c Common/Signature.c Common/GetKey.c Common/ToggleEcho.c Common/binTs.c Common/memeq.c -lsodium
