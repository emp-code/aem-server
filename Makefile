...
objects = main.o https.o https_common.o https_get.o https_post.o smtp.o Includes/Base64.o Includes/Brotli.o Includes/CharToInt64.o Includes/QuotedPrintable.o Includes/SixBit.o Message.o Database.o
