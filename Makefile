...
objects = main.o http.o https.o https_common.o https_get.o https_post.o smtp.o Includes/Base64.o Includes/Brotli.o Includes/QuotedPrintable.o Includes/SixBit.o Message.o Database.o
...
https_post.o: https_post.c https_common.h Includes/SixBit.h Database.h Message.h
